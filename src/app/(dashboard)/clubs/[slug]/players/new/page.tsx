      ...
      <div className="container mx-auto py-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
            ...
            <p className="text-sm">You need to be an Admin or Owner to add players to this club.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto py-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Register a new player to {club.name}</p>
        </div>

        <div className="bg-card border rounded-lg p-6">
          <PlayerForm clubId={club.id} clubSlug={club.slug} />
        </div>
      </div>
    </div>
  );
